package progress.com.dbase.AndroidDownloadFile;
...
public class DownloadFile extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if(Build.VERSION.SDK_INT>=23 && checkSelfPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                    ...
                    try{
                        ...
                        e.printStackTrace();
                        Toast.makeText(DownloadFile.this, "Cannot Create Folder", Toast.LENGTH_SHORT).show();
                    }
                    //this is your file location
                    new DownloadTask().execute("http://192.168.43.183/Dbase/machine.pdf");
                }
    ...
    private class DownloadTask extends AsyncTask<String,Integer,String>{
        ...
        protected void onPreExecute() {
            ...
            mProgressDialog.setOnCancelListener(new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialog) {
                    Toast.makeText(DownloadFile.this, "Download Cancelled", Toast.LENGTH_SHORT).show();
                    File dir = new File (Environment.getExternalStorageDirectory().getAbsolutePath()+
                            "/MyDownloadedFiles/"+file_name);
                    try{
                        dir.delete();
        ...
        protected void onPostExecute(String result) {
            ...
            if(result !=null){
                Toast.makeText(DownloadFile.this, "Errror: "+result, Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(DownloadFile.this, "Downloaded", Toast.LENGTH_SHORT).show();
